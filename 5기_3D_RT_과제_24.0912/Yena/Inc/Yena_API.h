...
//라이브러리 로드 옵션.
	...
	#ifdef _DEBUG  
		#ifdef _WIN64
			#pragma comment(lib, "Yena64d.lib")	//디버그 버전.(64비트)
		#elif _WIN32
			#pragma comment(lib, "Yenad.lib")		//디버그 버전
		#endif
	#else
		#ifdef _WIN64
			#pragma comment(lib, "Yena64.lib")		//릴리즈 버전.(64비트)
		#elif _WIN32
			#pragma comment(lib, "Yena.lib")		//릴리즈 버전.
		#endif
	#endif
#endif
